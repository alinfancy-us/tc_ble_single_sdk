...
/* 中文说明：本文件为 HCI（Host Controller Interface）示例工程的应用配置文件，
 * 通过宏定义选择 HCI 传输方式（UART/USB）、调试打印开关、目标 EVK 板型（B85/B87/TC321X）、
 * 系统时钟、看门狗以及 HCI UART 收发 FIFO 大小等参数。B85 对应 __PROJECT_8258_HCI__ 分支。
 */
