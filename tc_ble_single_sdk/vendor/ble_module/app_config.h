...
/*
 * 中文说明：
 * 本头文件为 ble_module 示例工程的功能开关与参数配置，包括电源管理/OTA/SPP/电量检测/Flash 保护等
 * 使能开关、调试日志开关、板卡选型以及 UART/GPIO 相关宏定义。其中部分宏根据
 * __PROJECT_8258_MODULE__(B85)/__PROJECT_8278_MODULE__(B87)/__PROJECT_TC321X_MODULE__(TC321X) 区分平台。
 */
#pragma once
